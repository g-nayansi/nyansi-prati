                ...
                <div className="col">
                    ...
                    <div className="row ">
                        <div className="col">
                           {/* 
                            ...
                            <img className="colimages" src="/images/Screenshot (291).png" alt="resort image"/> 
                    ...
                    <div className="row ">
                            ...
                            <div className="col ">
                               ...
                               <img className="colimages2" src="/images/Screenshot (292).png"></img>
                            </div>
                    </div>
                    <div className="row">
                        <div className="col">
                           <img className="colimage3" src="/images/Screenshot (290).png"></img>
                        </div>
                        <div className="col">
