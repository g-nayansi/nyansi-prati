...
function Aboutus(){
    ...
    return (
        ...
        >       
                ...
                <img className="dots2" src="images/Frame (1).png"></img>
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-7 col-12">
                            ...
                            <div className="desc3">
                                ...
                                <p className="gray">Plan and start an event via single click. Invite your guests without any<br /> hassle with our event
                    ...
                    <div className="row">
                        <div className="col-lg-7 col-12">
                            ...
                            <p className="gray2">Negotiate on your terms with the vendors best <br />suitable for your list of programs.</p>
                        </div>
                        <div className="col-lg-5 col-12">
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-7 col-12 desc3">
                            <p className="planning"><span className="bolding">Share Memories </span><br />With Others</p>
                            <div className="underline"></div>
                            <p className="gray">Share memories with others and give us next chance to <br />serve better for your future occasions.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-1 col-12"></div>
                            <div className="col-lg-5 col-12">
                                <img className="frame6" src="images/Group1780.svg" />
                                <p className="offer1"><span className="bolding">Avail Cost Effective</span><br /> premium services</p>
                            </div>
                            <div className="col-lg-5 col-12">
                                <img className="frame17" src="images/Group 1779.svg"></img>
                                <p className="offer3"><span className="bolding">24x7 Support</span><br />for our customers</p>
                            </div>
                        </div>
                    </div>
